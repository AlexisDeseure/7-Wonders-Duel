...
namespace Deck {
    ...
    public:
        DeckElement(const Building& building, const bool& visible = true, const DeckElement* right_son = nullptr, const DeckElement* left_son = nullptr,  const DeckElement* right_father = nullptr,  const DeckElement* left_father = nullptr ): right_son(right_son), left_son(left_son), right_father(right_father), left_father(left_father), building(building), visible(visible){};
        ~DeckElement() = default;
